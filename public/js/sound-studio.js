  ...
  if (src == '') {
    ...
    if (currentAudio == id) {
        ...
        if(isPlaying) {
            ...
            isPlaying = true;
            if (currentAudio) {
                document.getElementById(currentAudio).innerHTML = '<i class="fa fa-play table-action-buttons view-action-button"></i>';
            }
            document.getElementById(id).innerHTML = '<i class="fa fa-stop table-action-buttons view-action-button"></i>';
            currentAudio = id;
        }
    }
