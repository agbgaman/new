					...
					<div id="footer" class="container text-center">
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-12" id="footer-logo">
								...
								<p class="mb-0">Globose Technology Solutions Pvt Ltd (GTS) is an AI data collection Company that provides different Datasets like image datasets, video datasets, text datasets, speech datasets, etc. to train your machine learning model. Contact Us</p>
...
{{--									</div> <!-- END INFORMATION LINKS -->--}}
					...
					<div id="copyright" class="container">
						...
						<div>
							...
							<p class="copyright-right"><a href="{{ route('privacyPolicies') }}">{{ __('Privacy Policy') }}</a><span>|</span></p>
						</div>
