                                ...
                                <div class="form-group mb-3">
                                    <div class="d-flex">
                                        <label class="custom-switch">
                                            ...
                                            <span class="custom-switch-description fs-10 text-muted">{{__('By continuing, I agree with your')}} <a href="{{ route('terms') }}" class="text-info">{{__('Terms and Conditions')}}</a> {{__('and')}} <a href="{{ route('privacyPolicies') }}" class="text-info">{{__('Privacy Policies')}}</a></span>
                                        </label>
                                    </div>
                                </div>
