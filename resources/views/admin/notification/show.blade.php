		...
		<div class="col-lg-6 col-md-6 col-xm-12">
			<div class="card overflow-hidden border-0">
				...
				<div class="card-body pt-5">
                    @php
                        $data = json_decode($notification->data, true); // Decodes the JSON string into an associative array

                    @endphp
					<div class="row">
						<div class="col-lg-4 col-md-4 col-12">
							<h6 class="font-weight-bold mb-1">{{ __('Type') }}: </h6>
							<span class="fs-14">{{ $data['type'] }}</span>
						</div>
						<div class="col-lg-4 col-md-4 col-12">
							<h6 class="font-weight-bold mb-1">{{ __('User Action') }}: </h6>
							<span class="fs-14">{{ $data['action'] }}</span>
						</div>
						<div class="col-lg-4 col-md-4 col-12">
					...
					<div class="row pt-7">
						<div class="col-12">
							...
							<p class="fs-14 font-italic text-muted">{{ $data['subject'] }}</p>
						</div>
						<div class="col-12 mt-2">
							<h6 class="font-weight-bold mb-1">{{ __('Message') }}: </h6>
							<p class="fs-14 font-italic text-muted">{!! $data['message'] !!} </p>
						</div>
					</div>
