        ...
        <div class="col-xl-12 col-lg-12 col-sm-12">
            <div class="card border-0">
                ...
                <div class="card-body pb-0">
                    <form method="POST" action="{{ route('admin.image.update',['id'=> $image->id]) }}" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="input-box">
                                    ...
                                    <select class="form-control" id="folder" name="folder_id"
                                        ...
                                        @foreach($folders as $folder)
                                            <option value={{$folder->id}} @if($folder->id == $image->folder_id) selected @endif>{{$folder->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
