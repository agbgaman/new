...
@section('page-header')
    ...
    <div class="page-header mt-5-7">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">{{ __('All Text') }}</h4>
        ...
        <div class="page-rightheader">
            <a href="{{route('admin.csv.create')}}" class="btn btn-primary mt-1" type="button"  data-tippy-content="{{ __('Upload New CSV') }}" >Upload CSV</a>
        </div>
    </div>
    <!-- END PAGE HEADER -->
@endsection
