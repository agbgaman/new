        ...
        <div class="page-leftheader">
            ...
            <ol class="breadcrumb mb-2">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a
                        href="{{ route('admin.image.index') }}"> {{ __('User Images') }}</a></li>
            </ol>
        </div>
    </div>
    <!-- END PAGE HEADER -->
    ...
    <div class="row">
        ...
        <div id="sidebar" class="sidebar bg-light d-none">
            ...
            <div class="d-flex justify-content-between" style="color: white">
                ...
                <div class="custom-text"><strong>Similar:</strong></div>
...
@section('js')
    ...
    <script type="text/javascript">
        function getImageDupicacy(id) {
            $('#loader').show();

            $.ajax({
                url: '/admin/check-image-duplicacy/' + id,
                type: 'GET',
                success: function (response) {
                    ...
                    // Update the 'duplicate' paragraph with status and count
                    var statusText = (status == 'duplicate') ? 'Duplicate' : 'Unique';

                    // Construct the link
                    var url = '/admin/duplicate-images/' + id;
                    var link = "<a href='" + url + "' style='color: white; font-size: 18px;'>View Details</a>";

                    // Update the 'duplicate' paragraph with status, count, and the link
                    $('#duplicate').html(statusText + ': ' + count + ' ' + link);
