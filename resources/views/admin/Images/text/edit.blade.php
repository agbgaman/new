        ...
        <div class="page-leftheader">
            ...
            <ol class="breadcrumb mb-2">
                ...
                <li class="breadcrumb-item" aria-current="page"><a
                        href="{{ route('admin.text.index') }}"> {{ __('Text Management') }}</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="#"> {{ __('Edit Text') }}</a></li>
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12">
            <div class="card border-0">
                ...
                <div class="card-body pb-0">
                    <form method="POST" action="{{ route('admin.text.update',['id'=> $text->id]) }}"
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-6">
                                <div class="input-box">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('image') is-danger @enderror" name="text"
                                                  required>
                                            {{ $text->text }}
                                        </textarea>
                                        @error('text')
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="input-box">
                                    ...
                                    <select id="featured" name="folder_id"
                                            data-placeholder="{{ __('Select Folder') }} ">
                                        @foreach($folders as $folders)
                                            <option
                                                value={{$folders->id}} @if($folders->id == $text->folder_id) selected @endif>{{$folders->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
