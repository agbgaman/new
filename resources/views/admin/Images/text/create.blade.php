    ...
    <div class="page-header mt-5-7">
        <div class="page-leftheader">
            ...
            <ol class="breadcrumb mb-2">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="#"> {{ __('Upload CSV') }}</a></li>
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12">
            <div class="card border-0">
                ...
                <div class="card-body pb-0">
                    <form method="POST" action="{{ route('admin.text.store') }}" id="my-form"
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="input-box">
                                    <div class="form-group">
                                        ...
                                        <input type="file" accept=".csv" onclick="fillInput(event)" data-value="CSV"
                                               class="form-control @error('image') is-danger @enderror" name="csv"
