...
@section('page-header')
    ...
    <div class="page-header mt-5-7">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">{{ __('All Translation Text') }}</h4>
            <ol class="breadcrumb mb-2">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i
                            class="fa-solid fa-user-shield mr-2 fs-12"></i>{{ __('Admin') }}</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a
                        href="{{ route('admin.text.index') }}"> {{ __('User Text') }}</a></li>
            </ol>
        </div>

        <div class="page-rightheader">
            <a href="{{route('admin.text.create')}}" class="btn btn-primary mt-1" type="button"
               data-tippy-content="{{ __('Upload New CSV') }}">Upload CSV</a>
        </div>
    </div>
    <!-- END PAGE HEADER -->
@endsection
        ...
        <div class="col-lg-12 col-md-12 col-xm-12">
            <div class="card border-0">
                <div class="card-header flex justify-content-between">
                    <h3 class="card-title">{{ __('Text Management') }}</h3>
                </div>
                <div class="card-body pt-2">
                    ...
                    <div class="box-content">
                        ...
                        <table id='listFoldersTable' class='table listFoldersTable' width='100%'>
                            <thead>
                            <tr>
                                <td width="15%">{{ __('Text') }}</td>
                                <td width="15%">{{ __('Translated Text') }}</td>
