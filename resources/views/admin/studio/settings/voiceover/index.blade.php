	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			...
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="#"> {{ __('Voiceover Studio Settings') }}</a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
		...
		<div class="col-lg-8 col-md-12 col-xm-12">
			<div class="card overflow-hidden border-0">
				...
				<div class="card-body">
					...
					<!-- TTS SETTINGS FORM -->					
					<form action="{{ route('admin.voiceover.settings.store') }}" method="POST" enctype="multipart/form-data">
						@csrf
										...
										<div class="input-box">	
											<h6>Set Wasabi Region</h6>
											  <select id="set-wasabi-region" name="set-wasabi-region" data-placeholder="Select Default Wasabi Region:">			
												...
												<option value="ca-central-1" @if (config('services.wasabi.region') == 'ca-central-1') selected @endif>Wasabi CA Central 1 (Toronto) ca-central-1</option>
												...
												<option value="eu-central-2" @if (config('services.wasabi.region') == 'eu-central-2') selected @endif>Wasabi EU Central 2 (Frankfurt) eu-central-2</option>
												<option value="eu-west-1" @if (config('services.wasabi.region') == 'eu-west-1') selected @endif>Wasabi EU West 1 (London) eu-west-1</option>
												<option value="eu-west-2" @if (config('services.wasabi.region') == 'eu-west-2') selected @endif>Wasabi EU West 2 (Paris) eu-west-2</option>
												<option value="ap-northeast-1" @if (config('services.wasabi.region') == 'ap-northeast-1') selected @endif>Wasabi AP Northeast 1 (Tokyo) ap-northeast-1</option>
												<option value="ap-northeast-2" @if (config('services.wasabi.region') == 'ap-northeast-2') selected @endif>Wasabi AP Northeast 2 (Osaka) ap-northeast-2</option>
												<option value="ap-southeast-1" @if (config('services.wasabi.region') == 'ap-southeast-1') selected @endif>Wasabi AP Southeast 1 (Singapore) ap-southeast-1</option>
												<option value="ap-southeast-2" @if (config('services.wasabi.region') == 'ap-southeast-2') selected @endif>Wasabi AP Southeast 2 (Sydney) ap-southeast-2</option>
											</select>
