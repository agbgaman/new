	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			...
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item" aria-current="page"><a href="#"> {{ __('Voiceover Studio Results') }}</a></li>
				...
				<div class="card-body pt-5">
					...
					<div class="row">
						<div class="col-lg-4 col-md-4 col-12">
							<h6 class="font-weight-bold mb-1">{{ __('Vendor') }}: </h6>
					...
					<div class="border-0 text-right mb-2 mt-8">
						<a href="{{ route('admin.voiceover.results') }}" class="btn btn-primary">{{ __('Return') }}</a>
					</div>
				</div>
			</div>
		</div>
