                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select id="user-role" name="role" data-placeholder="{{ __('Select User Role') }}" required>
                                        ...
                                        <option value="quality_assurance">{{ __('Quality Assurance') }}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="currency2" name="currency" data-placeholder="Select Currency">
                                        @foreach(config('currencies.all') as $key => $value)
                                            <option value="{{ $key }}" @if(config('payment.default_system_currency') == $key) selected @endif>{{ $value['name'] }} - {{ $key }} )</option>
                                        @endforeach
                                    </select>
                                    @error('currency')
