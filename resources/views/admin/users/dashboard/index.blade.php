	...
	<div class="row">
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card border-0">
				<div class="card-body">
					<i class="fa-solid fa-user-group-crown text-success fs-35 mt-3 float-right"></i>	
			...
			<div class="card overflow-hidden border-0">
				...
				<div class="card-body">
					<div class="row mb-5 mt-2">
						...
						<div class="col-xl-3 col-6 ">
							<p class=" mb-1 fs-12">{{ __('Total Subscriber Users') }}</p>
...
@section('js')
	...
	<script type="text/javascript">
		$(function() {
			...
			let paidData = JSON.parse(`<?php echo $chart_data['paid_registration_yearly']; ?>`);
			let paidDataset = Object.values(paidData);
			let delayed1;
