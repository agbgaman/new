...
@section('page-header')
	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			<h4 class="page-title mb-0">{{ __('Update Bank Transaction') }}</h4>
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="#"> {{ __('Update Bank Transaction') }}</a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
			...
			<div class="card border-0">
				...
				<div class="card-body pt-5">		
					...
					<div class="row pt-5">
						...
						<div class="col-lg-4 col-md-4 col-12">
							<h6 class="font-weight-bold mb-1">{{ __('Characters') }}: </h6>
							<span class="fs-14">{{ number_format($id->characters) }}</span>
						</div>
						<div class="col-lg-4 col-md-4 col-12">
							<h6 class="font-weight-bold mb-1">{{ __('Minutes') }}: </h6>
