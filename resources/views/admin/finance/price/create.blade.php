                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="price_name" name="price_name" value="{{ old('price_name') }}" required>
                                    </div>
                                    @error('price_name')
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <input type="number" step="0.01" class="form-control" id="commission" name="commission" value="{{ old('price') }}" required>
                                    </div>
                                    @error('price')
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                <input type="number" class="form-control" id="image_price" name="image_price" value="{{ old('image_price') }}" required>
                                            </div>
                                            @error('image_price')
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                <input type="number" class="form-control" id="text_price" name="text_price" value="{{ old('text_price') }}" required>
                                            </div>
                                            @error('text_price')
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                <input type="number" class="form-control" id="coco_price" name="coco_price" value="{{ old('coco_price') }}" required>
                                            </div>
                                            @error('coco_price')
