    ...
    <div class="page-header mt-5-7">
        <div class="page-leftheader">
            ...
            <ol class="breadcrumb mb-2">
                <li class="breadcrumb-item"><a href="#"><i class="fa-solid fa-user-shield mr-2 fs-12"></i>{{ __('User') }}</a></li>
                <li class="breadcrumb-item"><a href="{{route('user.referral')}}">{{ __('Account') }}</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="#"> {{ __(' Report') }}</a></li>
            </ol>
        </div>
