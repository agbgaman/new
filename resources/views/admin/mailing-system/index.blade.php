...
@section('page-header')
    ...
    <div class="page-header mt-5-7">
        ...
        <div class="page-rightheader">
            <a href="{{ route('admin.mailing.system.user.create') }}" class="btn btn-primary mt-1">{{ __('Create User List') }}</a>
        </div>
    </div>
    <!-- END PAGE HEADER -->
@endsection
        ...
        <div class="col-lg-12 col-md-12 col-xm-12">
            <div class="card border-0">
                <div class="card-header flex justify-content-between">
                    <h3 class="card-title">{{ __('User List Management') }}</h3>
                </div>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('#listFoldersTable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.mailing.system.index') }}",
                columns: [
                    {
                        data: 'created-on',
                        name: 'created-on',
