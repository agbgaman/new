        ...
        <div class="col-lg-12 col-md-12 col-xm-12">
            <div class="card border-0">
                <div class="card-header flex justify-content-between">
                    <h3 class="card-title">{{ __('Campaign Management') }}</h3>
                </div>
                    ...
                    <div class="box-content">
                        ...
                        <table id='listFoldersTable' class='table listFoldersTable' width='100%'>
                            ...
                            <tr>
                                ...
                                <th width="8%">{{ __('Total Users') }}</th>
                                <th width="6%">{{ __('Email Read by') }}</th>
                                <th width="8%">{{ __('Unsubscribe User') }}</th>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('#listFoldersTable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.mailing.system.report') }}",
                columns: [
                    {
                        data: 'created-on',
                        name: 'created-on',
