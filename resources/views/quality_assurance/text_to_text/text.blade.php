        ...
        <div class="page-leftheader">
            ...
            <ol class="breadcrumb mb-2">
                ...
                <li class="breadcrumb-item" aria-current="page"><a
                        href="{{route('user.transcribe.file')}}"> {{ __('Text Results') }}</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a
                        href="{{url('#')}}"> {{ __('Text Results') }}</a></li>
            </ol>
        </div>
    </div>
    <!-- END PAGE HEADER -->
...
@section('content')
    ...
    <div id="sidebar" class="sidebar bg-light d-none" style="z-index: 9999;">
        <h5 class="ml-3 mb-4" style="color: white">Text Details</h5>
                ...
                <div class="modal-body p-0">
                    <div class="row no-gutters h-100">
                        ...
                        <div class="mt-8 text-center">
                            <!-- Added text area -->
                            <p class="form-control" id="translated_text"></p>
                        </div>
