...
@section('page-header')
	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			<h4 class="page-title mb-0">{{ __('Background Music') }}</h4>
		...
		<div class="col-lg-12 col-md-12 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-header">
					...
					<a href="{{ route('user.sound.studio') }}" class="btn btn-primary pr-5 pl-5" id="return-sound">{{ __('Sound Mix Studio') }}</a>	
				</div>
	...
	<script type="text/javascript">
		$(function () {	
			...
			var table = $('#notificationsTable').DataTable({
				...
				processing: true,
				serverSide: true,
				ajax: "{{ route('user.sound.studio.music.list') }}",
				columns: [{
						data: 'created-on',
						name: 'created-on',
						orderable: true,
