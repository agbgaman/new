						...
						@csrf
								...
								<div class="col-md-12 col-sm-12">
									<div id="storage-type-radio" role="radiogroup">
										<div class="radio-control">
											<input type="radio" name="payment_method" class="input-control" id="Payoneer" value="Payoneer" @if ($user->referral_payment_method == 'Payoneer') checked @endif style="vertical-align: middle;">
											<label for="Payoneer" class="label-control fs-12">Payoneer</label>
										</div>
										<div class="radio-control">
							...
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12">
									<div class="input-box">
										<h6>{{ __('Enter your Payoneer Email') }}</h6>
										<div class="form-group">
											<input type="text" class="form-control @error('paypal') is-danger @enderror" id="payoneer" name="payoneer" value="{{ $user->payoneer }}">
										</div>
										@error('paypal')
