	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			...
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="#"> {{ __('Change Password') }}</a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER-->
				...
				<div class="card-body">
					...
					<form method="POST" action="{{ route('user.security.password', [auth()->user()->id]) }}" enctype="multipart/form-data">
						...
						<div class="card-footer border-0 text-right mt-2 pr-0 pb-0">
							<a href="{{ route('user.dashboard', [auth()->user()->id]) }}" class="btn btn-cancel mr-2">{{ __('Cancel') }}</a>
