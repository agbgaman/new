...
trait InvoiceGeneratorTrait
{
    ...
    {   
        ...
        $plan = ($payment->plan_type == 'prepaid') ? PrepaidPlan::where('id', $payment->plan_id)->first() : SubscriptionPlan::where('id', $payment->plan_id)->first();
        $description = 'Total Characters: ' . $plan->characters . '; Total Minutes: ' . $plan->minutes;
    ...
    {   
        ...
        $plan = ($id->plan_type == 'prepaid') ? PrepaidPlan::where('id', $id->plan_id)->first() : SubscriptionPlan::where('id', $id->plan_id)->first();
        $description = 'Total Characters: ' . $plan->characters . '; Total Minutes: ' . $plan->minutes;
