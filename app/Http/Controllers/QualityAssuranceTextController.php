...
class QualityAssuranceTextController extends Controller
{
...
//                    })
                ...
                ->addColumn('text_count', function ($row) {
                    ...
                    $text_count = '<a href="' . route("qa.text-folder-by-id", $row["id"]) . '"><span class="font-weight-bold-' . $textCount . '"">' . $textCount . '</span></a>';
                    return $text_count;
                })
        ...
        return view('quality_assurance.text.folder');
    }
    ...
    public function textFolder(Request $request,$id){
        return view('quality_assurance.text.text',compact('id'));
