...
{   
    ...
    public function store(Request $request)
    {
        ...
        if ($status['status'] == true) {
            ...
            return redirect()->back()->with('success', __('Application license was successfully activated'));
        } else {
            return redirect()->back()->with('error', __('There was an error while activating your application, please contact support team.') . $status['message']);
        }
    ...
    public function destroy()
    {
        ...
        if ($verify['status']) {
            ...
            $notification = false;
            return redirect()->back()->with(['success' => __('Application license was successfully deactivated')], compact('notification'));
        }
    }
