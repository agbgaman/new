        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                    ...
                    ->addColumn('username', function($row){
                        ...
                        if($user) {
                            $username = '<span class="font-weight-bold">'.$user->name.'</span><br><span class="text-muted">'.$user->email.'</span>';
                        } else {
                            $username = '<span class="font-weight-bold">N/A</span><br><span class="text-muted">N/A</span>';
                        }
                        return $username;
                    })
