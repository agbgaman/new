...
use App\Listeners\ProjectCompleteListener;
use App\Listeners\ProjectPermissionListener;
...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        ProjectCompleteEvent::class => [
            ProjectCompleteListener::class
        ],
        ProjectPermissionEvent::class => [
            ProjectPermissionListener::class
        ],
